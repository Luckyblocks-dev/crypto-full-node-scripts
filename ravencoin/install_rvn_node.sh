...
cecho "GREEN" "*********************************"
cecho "CYAN" "Would you like to send a tip or buy me a coffee?"
cecho "GREEN" "Donations also help keep Ravenpool.ninja always zero-fee mining forever!"
cecho "PURPLE" "You can send RVN to RBg1dCtD7qHPhX7XZDvzer1fKSAsCv9vVE"
cecho "GREEN" "support@ravenpool.ninja"
